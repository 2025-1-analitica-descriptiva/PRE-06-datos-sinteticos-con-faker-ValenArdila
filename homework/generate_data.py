...
def generate_fake_timesheet(drivers, n):
    ...
    """
    timesheet = []
    for i in tqdm(range(n), desc="timesheet"): #tqm sirve para mostrsr uns linea de progreso cuando se corre
        record = {
...
def save_fake_data(fake_data, filename): #Lo guarda en formato csv. 
